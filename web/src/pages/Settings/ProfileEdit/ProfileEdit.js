              ...
              <CardBody>
                ...
                <FormGroup className="mb-4" row>
                  ...
                  <Col md="9">
                    ...
                    <span className="font-13 text-muted">
                      e.g "Senior front-end developer with 5+ years of
                      experience"
                    </span>
                  </Col>
                </FormGroup>
                ...
                <FormGroup className="mb-4" row>
                  ...
                  <Col md="9">
                    ...
                    ></textarea>
                    <span className="font-13 text-muted">
                      e.g "A short greeting to visitors"
                    </span>
                  </Col>
                </FormGroup>
                ...
                <FormGroup className="mb-4" row>
                  ...
                  <Col md="5">
                    <Input
                      id="linkedinLink"
                      value={
                        values?.linkedinLink || 'https://www.linkedin.com/'
                      }
                      onChange={handleChange}
                      onBlur={handleBlur}
                      type="text"
...
export default connect(mapStateToProps, { fetchProfile })(ProfileEdit)
